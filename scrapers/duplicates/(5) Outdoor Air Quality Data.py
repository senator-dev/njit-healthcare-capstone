...
data = data[data['bucket'].isin([12, 13, 14])]
data = data.iloc[1228 + 910:, :]
...
spark.createDataFrame(tmp)

# COMMAND ----------

# MAGIC %sql
# MAGIC insert into default.air_pollutants
# MAGIC select * from new_insert
